...
from setup import (
    ...
    print_failure_message, _lint, _test, _test_integration, _test_all,
    CODE_DIRECTORY, DOCS_DIRECTORY, UNIT_TESTS_DIRECTORY, PYTEST_FLAGS)
...
def test_integration():
    ...
    raise SystemExit(_test_integration())
